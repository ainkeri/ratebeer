class BeerClubsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @beer_club.update(beer_club_params)
        format.html { redirect_to @beer_club, notice: "Beer club was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to beer_clubs_path, notice: "Beer club was successfully destroyed.", status: :see_other }
